    ...
    <div>
      ...
      >
        <div className="text-center -mt-24 md:-mt-60 px-4 sm:px-6" data-aos="fade-up">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-cormorant tracking-wide">
            11:11 PHOTOGRAPHY
          </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 p-4 sm:p-6 md:p-8">
        ...
        <div
          ...
          data-aos="fade-left"
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-4 font-cormorant">About Me</h1>
          <p className="text-gray-700 max-w-xl font-cormorant text-sm sm:text-base md:text-lg">
